...
public class AppModule
{
            ...
            MappedConfiguration<String, String> configuration)
    {
        ...
        configuration.add(SymbolConstants.SUPPORTED_LOCALES, "rs, en, en_US");
        configuration.add("tapestry.start-page-name", "Index_rs");
...
/**
    ...
    public void contributeMasterDispatcher(OrderedConfiguration<Dispatcher> configuration,
			@InjectService("ProtectPageService")
			Dispatcher ProtectPageService) {
